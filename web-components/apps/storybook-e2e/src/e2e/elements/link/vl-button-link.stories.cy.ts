describe('story vl-button-link', () => {
    it('should contain a link styled as a button', () => {
        cy.visit('http://localhost:8080/iframe.html?id=elements-link--button-link-default&viewMode=story');
    ...
    it('should contain a button link with an error state', () => {
        cy.visit(
            'http://localhost:8080/iframe.html?args=error:true&id=elements-link--button-link-default&viewMode=story'
        );
    ...
    it('should contain a small button link', () => {
        cy.visit(
            'http://localhost:8080/iframe.html?args=small:true&id=elements-link--button-link-default&viewMode=story'
        );
    ...
    it('should contain a large button-link', () => {
        cy.visit(
            'http://localhost:8080/iframe.html?args=large:true&id=elements-link--button-link-default&viewMode=story'
        );
    ...
    it('should contain a bold button-link', () => {
        cy.visit(
            'http://localhost:8080/iframe.html?args=bold:true&id=elements-link--button-link-default&viewMode=story'
        );
