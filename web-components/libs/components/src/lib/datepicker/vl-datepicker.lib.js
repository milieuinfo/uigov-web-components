        ...
        (function (global, factory) {
            ...
            ***************************************************************************** */
            ...
            function compareDates(date1, date2, timeless) {
                ...
                if (timeless !== false) {
                    return (
                        new Date(date1.getTime()).setHours(0, 0, 0, 0) - new Date(date2.getTime()).setHours(0, 0, 0, 0)
                    );
                }
            ...
            function FlatpickrInstance(element, instanceConfig) {
                ...
                function init() {
                    ...
                    if (self.selectedDates.length || self.config.noCalendar) {
                        if (self.config.enableTime) {
                            setHoursFromDate(
                                self.config.noCalendar ? self.latestSelectedDateObj || self.config.minDate : undefined
                            );
                        }
                ...
                function updateTime(e) {
                    if (self.selectedDates.length === 0) {
                        var defaultDate =
                            self.config.minDate !== undefined ? new Date(self.config.minDate.getTime()) : new Date();
                ...
                function buildTime() {
                    ...
                    self.minuteElement.value = pad(
                        self.latestSelectedDateObj ? self.latestSelectedDateObj.getMinutes() : self.config.defaultMinute
                    );
                ...
                function parseConfig() {
                    ...
                    var userConfig = _assign(
                        _assign({}, JSON.parse(JSON.stringify(element.dataset || {}))),
                        instanceConfig
                    );
                ...
                function setupLocale() {
                    ...
                    self.l10n = _assign(
                        _assign({}, flatpickr.l10ns.default),
                        _typeof(self.config.locale) === 'object'
                            ? self.config.locale
                ...
                function parseDateRules(arr) {
                    return arr
                        ...
                        .map(function (rule) {
                            ...
                            } else if (rule && _typeof(rule) === 'object' && rule.from && rule.to) {
                                return {
                ...
                function isDateInRange(date) {
                    ...
                    return (
                        compareDates(date, self.selectedDates[0]) >= 0 && compareDates(date, self.selectedDates[1]) <= 0
                    );
                }
        ...
        _createClass(Datepicker, [
            {
                ...
                value: function dress(datepicker) {
                    var datepickerInput = datepicker.querySelector('.'.concat(datePickerInputclass)),
                        ...
                        datepickerDateFormat = datepicker.getAttribute(datePickerDataFormat)
                            ? datepicker.getAttribute(datePickerDataFormat)
                            : 'd.m.Y',
                        datePickerVisualFormat = datepicker.getAttribute(datePickerDataVisualFormat)
                            ? datepicker.getAttribute(datePickerDataVisualFormat)
                            : 'd.m.Y',
                    ...
                    var settings = {
                        ...
                        time_24hr: datepicker.getAttribute(datePicker24hrTime)
                            ? datepicker.getAttribute(datePicker24hrTime)
                            : true,
                    ...
                    var isCurrentDate = function isCurrentDate(value) {
                        ...
                        var currentValue = fltpckr.selectedDates
                            .map(function (date) {
            ...
            },
            {
                ...
                value: function dressAll() {
                    ...
                    var datepickers = document.querySelectorAll(
                        '.'
                            .concat(datePickerclass, ':not([data-')
                            .concat(vl.ns, "js-dress='false']),\n      [")
                            .concat(datepickerData, ']:not([data-')
                            .concat(vl.ns, "js-dress='false'])")
                    );
