            ...
            return (function (e) {
                    ...
                    var m = (function () {
                        function e() {
                            ...
                            if (
                                ...
                                (this.config = (0, v.extend)(a, i)),
                                'auto' !== this.config.renderSelectedChoices &&
                                    'always' !== this.config.renderSelectedChoices &&
                                    (this.config.silent ||
                                        console.warn(
                                            "renderSelectedChoices: Possible values are 'auto' and 'always'. Falling back to 'auto'."
                                        ),
                                    (this.config.renderSelectedChoices = 'auto')),
                                (this.store = new f.default(this.render)),
                                (this.initialised = !1),
                                (this.currentState = {}),
                                (this.prevState = {}),
                                (this.currentValue = ''),
                                (this.element = t),
                                (this.passedElement = (0, v.isType)('String', t) ? document.querySelector(t) : t),
                                !this.passedElement)
                            )
                                return void (this.config.silent || console.error('Passed element not found'));
                            (this.isTextElement = 'text' === this.passedElement.type),
                                (this.isSelectOneElement = 'select-one' === this.passedElement.type),
                                (this.isSelectMultipleElement = 'select-multiple' === this.passedElement.type),
                                (this.isSelectElement = this.isSelectOneElement || this.isSelectMultipleElement),
                                (this.isValidElementType = this.isTextElement || this.isSelectElement),
                                (this.isIe11 = !(
                                    !navigator.userAgent.match(/Trident/) || !navigator.userAgent.match(/rv[ :]11/)
                                )),
                                (this.isScrollingOnIe = !1),
                                this.config.shouldSortItems === !0 &&
                                ...
                                (this.baseId = (0, v.generateId)(this.passedElement, 'choices-')),
                            ...
                            a(e, [
                                    ...
                                    value: function value() {
                                        if (this.initialised !== !0) {
                                            ...
                                            (this.initialised = !0),
                                                ...
                                                e && (0, v.isType)('Function', e) && e.call(this);
                                        }
                                    },
                                },
                                {
                                        ...
                                        if (this.initialised !== !1) {
                                            ...
                                            Boolean(e)
                                                ? (this.passedElement.removeAttribute('data-choice-orig-style'),
                                                  this.passedElement.setAttribute('style', e))
                                ...
                                },
                                {
                                    ...
                                    value: function value(e, t, i) {
                                        ...
                                        return (
                                            this.config.shouldSort && e.sort(o),
                                            e.forEach(function (e) {
                                                var i = t.filter(function (t) {
                                                    return n.isSelectOneElement
                                                        ? t.groupId === e.id
                                    ...
                                    value: function value(e) {
                                        ...
                                        if (
                                            ...
                                            e.forEach(function (e) {
                                                ...
                                                this.passedElement.appendChild(r);
                                        }
                                        ...
                                        if (
                                            ...
                                            if (
                                                ...
                                                (this.choiceList.innerHTML = ''),
                                                    this.config.resetScrollPosition && (this.choiceList.scrollTop = 0),
                                                ...
                                                if (i.childNodes && i.childNodes.length > 0)
                                                    s.response
                                                        ...
                                                        : this.choiceList.appendChild(
                                                              this._getTemplate('notice', s.notice)
                                                          );
                                                else {
                                                    var o = void 0,
                                                        r = void 0;
                                                    this.isSearching
                                                        ? ((r = (0, v.isType)('Function', this.config.noResultsText)
                                                              ? this.config.noResultsText()
                                                              : this.config.noResultsText),
                                                          (o = this._getTemplate('notice', r, 'no-results')))
                                                        : ((r = (0, v.isType)('Function', this.config.noChoicesText)
                                                              ? this.config.noChoicesText()
                                                              : this.config.noChoicesText),
                                                          (o = this._getTemplate('notice', r, 'no-choices'))),
                                                        this.choiceList.appendChild(o);
                                                }
                                            }
                                ...
                                },
                                {
                                    ...
                                    value: function value(e) {
                                        ...
                                        return (
                                            this.store.dispatch((0, p.highlightItem)(i, !0)),
                                            t &&
                                                (s && s.value
                                ...
                                },
                                {
                                    ...
                                    value: function value(e) {
                                        ...
                                        return (
                                            this.store.dispatch((0, p.highlightItem)(t, !1)),
                                            n && n.value
                                ...
                                },
                                {
                                    ...
                                    value: function value() {
                                        ...
                                        var s = this.dropdown.getBoundingClientRect(),
                                            ...
                                            r = !1;
                                        return (
                                            'auto' === this.config.position
                                                ? (r = o >= n)
                                                : 'top' === this.config.position && (r = !0),
                                            r && this.containerOuter.classList.add(this.config.classNames.flippedState),
                                            e &&
                                                this.canSearch &&
                                                activeElement(document.activeElement) !== this.input &&
                                                this.input.focus(),
                                            (0, v.triggerEvent)(this.passedElement, 'showDropdown', {}),
                                            this
                                        );
                                    },
                                },
                                {
                                    ...
                                    value: function value() {
                                        var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                                            t = this.containerOuter.classList.contains(
                                        ...
                                        return (
                                            ...
                                            e &&
                                                ...
                                                activeElement(document.activeElement) === this.input &&
                                                this.input.blur(),
                                            (0, v.triggerEvent)(this.passedElement, 'hideDropdown', {}),
                                            this
                                        );
                                    },
                                },
                                    ...
                                    value: function value() {
                                        return (
                                            ...
                                            !this.isTextElement &&
                                                ...
                                                ((this.isSearching = !1),
                                                this.store.dispatch((0, p.activateChoices)(!0))),
                                            this
                                        );
                                    },
                                },
                                ...
                                },
                                {
                                    ...
                                    value: function value(e) {
                                        e != null &&
                                            (0, v.triggerEvent)(this.passedElement, 'change', {
                                                value: e,
                                            });
                                    },
                                },
                                    ...
                                    value: function value(e, t) {
                                        if (e && t && this.config.removeItems && this.config.removeItemButton) {
                                            ...
                                            this._removeItem(n),
                                                ...
                                                this.isSelectOneElement && this._selectPlaceholderChoice();
                                        }
                                    },
                                },
                                {
                                    ...
                                    value: function value() {
                                        ...
                                        e &&
                                            (this._addItem(e.value, e.label, e.id, e.groupId, null, e.placeholder),
                                    ...
                                    value: function value(e, t) {
                                        if (e && t) {
                                            var i = t.getAttribute('data-id'),
                                                ...
                                                o = this.dropdown.classList.contains(
                                                    this.config.classNames.activeState
                                                );

                                            if (
                                                ((n.keyCode = s),
                                                (0, v.triggerEvent)(this.passedElement, 'choice', {
                                                    choice: n,
                                                }),
                                            ...
                                            this.clearInput(),
                                                o &&
                                                    this.isSelectOneElement &&
                                                    (this.hideDropdown(), this.containerOuter.focus());
                                        }
                                    },
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    value: function value(e, t) {
                                        var i = !0,
                                            n = (0, v.isType)('Function', this.config.addItemText)
                                                ? this.config.addItemText(t)
                                                : this.config.addItemText;
                                        (this.isSelectMultipleElement || this.isTextElement) &&
                                            this.config.maxItemCount > 0 &&
                                            this.config.maxItemCount <= e.length &&
                                            ((i = !1),
                                            (n = (0, v.isType)('Function', this.config.maxItemText)
                                        ...
                                        return (
                                            s ||
                                                ...
                                                !i ||
                                                ((i = !1),
                                                (n = (0, v.isType)('Function', this.config.uniqueItemText)
                                            ...
                                            if (t && i) {
                                                ...
                                                s && (0, v.isType)('Array', s) && s.length
                                                    ? (e._handleLoadingState(!1),
                                                      ...
                                                      e._setLoading(!1),
                                                      e.isSelectOneElement && e._selectPlaceholderChoice())
                                                    : e._handleLoadingState(!1),
                                                    e.containerOuter.removeAttribute('aria-busy');
                                            }
                                        };
                                    },
                                },
                                {
                                    ...
                                    value: function value(e) {
                                        var t = (0, v.isType)('String', e) ? e.trim() : e,
                                            i = (0, v.isType)('String', this.currentValue)
                                        ...
                                        if (t.length >= 1 && t !== i + ' ') {
                                            var n = this.store.getSearchableChoices(),
                                                s = t,
                                                o = (0, v.isType)('Array', this.config.searchFields)
                                            ...
                                            return (
                                                ...
                                                (this.highlightPosition = 0),
                                                (this.isSearching = !0),
                                                this.store.dispatch((0, p.filterChoices)(c)),
                                                c.length
                                            );
                                        }
                                ...
                                },
                                {
                                    ...
                                    value: function value(e) {
                                        if (e) {
                                            ...
                                            if (this.input === activeElement(document.activeElement))
                                                if (e && e.length >= this.config.searchFloor) {
                                                    var n = 0;
                                                    this.config.searchChoices && (n = this._searchChoices(e)),
                                                        (0, v.triggerEvent)(this.passedElement, 'search', {
                                                            value: e,
                                                            resultCount: n,
                                                        });
                                                } else
                                    ...
                                    value: function value(e) {
                                        ...
                                        if (e.target === this.input || this.containerOuter.contains(e.target)) {
                                            var n = e.target,
                                                ...
                                                a = this.dropdown.classList.contains(
                                                    this.config.classNames.activeState
                                                ),
                                            ...
                                            var _ = function _() {
                                                    E &&
                                                        c &&
                                                        ((i.canSearch = !1),
                                                        i.config.removeItems &&
                                                            !i.input.value &&
                                                            i.input === activeElement(document.activeElement) &&
                                                            i.highlightAll());
                                                },
                                                S = function S() {
                                                    ...
                                                    if (
                                                        (n.hasAttribute('data-button') &&
                                                            (i._handleButtonAction(o, n), e.preventDefault()),
                                                        a)
                                                    ) {
                                                        e.preventDefault();
                                                        var r = i.dropdown.querySelector(
                                                            '.' + i.config.classNames.highlightedState
                                                        );
                                                        r && (o[0] && (o[0].keyCode = d), i._handleChoiceAction(o, r));
                                                    } else
                                                        i.isSelectOneElement &&
                                                            (a || (i.showDropdown(!0), e.preventDefault()));
                                                },
                                                I = function I() {
                                                    ...
                                                    if (a || i.isSelectOneElement) {
                                                        ...
                                                        if (n)
                                                            s =
                                                                t > 0
                                                                    ? Array.from(
                                                                          i.dropdown.querySelectorAll(
                                                                              '[data-choice-selectable]'
                                                                          )
                                                                      ).pop()
                                                                    : i.dropdown.querySelector(
                                                                          '[data-choice-selectable]'
                                                                      );
                                                        else {
                                                            var o = i.dropdown.querySelector(
                                                                '.' + i.config.classNames.highlightedState
                                                            );
                                                            s = o
                                                                ? (0, v.getAdjacentEl)(o, '[data-choice-selectable]', t)
                                                                : i.dropdown.querySelector('[data-choice-selectable]');
                                                        }
                                                        s &&
                                                            ((0, v.isScrolledIntoView)(s, i.choiceList, t) ||
                                                                i._scrollToChoice(s, t),
                                                            i._highlightChoice(s)),
                                                            e.preventDefault();
                                                    }
                                                },
                                                T = function T() {
                                                    !r ||
                                                        e.target.value ||
                                                        i.isSelectOneElement ||
                                                        (i._handleBackspace(o), e.preventDefault());
                                                },
                                                C =
                                                    ((t = {}),
                                                    s(t, f, _),
                                ...
                                },
                                {
                                    ...
                                    value: function value(e) {
                                        if (e.target === this.input) {
                                            ...
                                            if (this.isTextElement) {
                                                var s = this.dropdown.classList.contains(
                                                    this.config.classNames.activeState
                                                );
                                ...
                                },
                                {
                                    ...
                                    value: function value(e) {
                                        ...
                                        if (
                                            (t === this.choiceList && this.isIe11 && (this.isScrollingOnIe = !0),
                                            this.containerOuter.contains(t) && t !== this.input)
                                        ) {
                                            var i = void 0,
                                                n = this.store.getItemsFilteredByActive(),
                                                s = e.shiftKey;
                                            (i = (0, v.findAncestorByAttrName)(t, 'data-button'))
                                                ? this._handleButtonAction(n, i)
                                                : (i = (0, v.findAncestorByAttrName)(t, 'data-item'))
                                                ? this._handleItemAction(n, i, s)
                                                : (i = (0, v.findAncestorByAttrName)(t, 'data-choice')) &&
                                                  this._handleChoiceAction(n, i),
                                                e.preventDefault();
                                        }
                                    },
                                },
                                ...
                                },
                                {
                                    ...
                                    value: function value(e) {
                                        ...
                                        if (this.containerOuter.contains(i)) {
                                            var n = this.dropdown.classList.contains(
                                                    this.config.classNames.activeState
                                                ),
                                                s = {
                                                    text: function text() {
                                                        i === t.input &&
                                                            t.containerOuter.classList.add(
                                                                t.config.classNames.focusState
                                                            );
                                                    },
                                                    'select-one': function selectOne() {
                                                        t.containerOuter.classList.add(t.config.classNames.focusState),
                                                            i === t.input && (n || t.showDropdown());
                                                    },
                                ...
                                },
                                {
                                    ...
                                    value: function value(e) {
                                        ...
                                        if (this.containerOuter.contains(i) && !this.isScrollingOnIe) {
                                            var n = this.store.getItemsFilteredByActive(),
                                                s = this.dropdown.classList.contains(
                                                    this.config.classNames.activeState
                                                ),
                                                o = n.some(function (e) {
                                                    return e.highlighted;
                                    ...
                                    value: function value() {
                                        ...
                                        if (i && i.length) {
                                            ...
                                            s.forEach(function (t) {
                                                ...
                                                n
                                                    ? (this.highlightPosition = i.indexOf(n))
                                                    : ((n =
                                                ...
                                                this.containerOuter.setAttribute('aria-activedescendant', n.id);
                                        }
                                    },
                                },
                                {
                                    ...
                                    value: function value(e) {
                                        ...
                                        return (
                                            ...
                                            this.config.appendValue && (a += this.config.appendValue.toString()),
                                            this.store.dispatch((0, p.addItem)(a, h, f, u, n, s, o, c)),
                                            this.isSelectOneElement && this.removeActiveItems(f),
                                            d && d.value
                                ...
                                },
                                {
                                    ...
                                    value: function value(e) {
                                        ...
                                        return (
                                            this.store.dispatch((0, p.removeItem)(t, s)),
                                            r && r.value
                                ...
                                },
                                {
                                    ...
                                    value: function value(e) {
                                        ...
                                        if ('undefined' != typeof e && null !== e) {
                                            ...
                                            this.store.dispatch((0, p.addChoice)(e, l, h, s, n, u, o, r, a)),
                                                i && this._addItem(e, l, h, void 0, o, r, a);
                                        }
                                    },
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    value: function value() {
                                        var e = this,
                                                ...
                                                itemList: function itemList() {
                                                    var i,
                                                        n = (0, u.default)(
                                                            t.list,
                                                            ((i = {}),
                                                            s(i, t.listSingle, e.isSelectOneElement),
                                                            s(i, t.listItems, !e.isSelectOneElement),
                                                            i)
                                                        );
                                                    return (0, v.strToEl)(
                                                        '\n          <div class="' + n + '"></div>\n        '
                                                ...
                                                item: function item(i) {
                                                    var n,
                                                        o = (0, u.default)(
                                                            t.item,
                                                            ((n = {}),
                                                            s(n, t.highlightedState, i.highlighted),
                                                            s(n, t.itemSelectable, !i.highlighted),
                                                            s(n, t.placeholder, i.placeholder),
                                                            n)
                                                        );
                                                    ...
                                                    if (e.config.removeItemButton) {
                                                        ...
                                                        return (
                                                            (o = (0, u.default)(
                                                                t.item,
                                                                ((r = {}),
                                                                s(r, t.highlightedState, i.highlighted),
                                                                s(r, t.itemSelectable, !i.disabled),
                                                                s(r, t.placeholder, i.placeholder),
                                                                r)
                                                            )),
                                                            (0, v.strToEl)(
                                                                '\n            <div\n              class="' +
                                                ...
                                                choice: function choice(i) {
                                                    var n,
                                                        o = (0, u.default)(
                                                            ...
                                                            t.itemChoice,
                                                            ((n = {}),
                                                            s(n, t.itemDisabled, i.disabled),
                                                            s(n, t.itemSelectable, !i.disabled),
                                                            s(n, t.placeholder, i.placeholder),
                                                            n)
                                                        );
                                                    return (0, v.strToEl)(
                                                ...
                                                notice: function notice(e) {
                                                    var i,
                                                        ...
                                                        o = (0, u.default)(
                                                            ...
                                                            t.itemChoice,
                                                            ((i = {}),
                                                            s(i, t.noResults, 'no-results' === n),
                                                            s(i, t.noChoices, 'no-choices' === n),
                                                            i)
                                                        );
                                                    return (0, v.strToEl)(
                                                        '\n          <div class="' +
                                            ...
                                            o = {};
                                        n && (0, v.isType)('Function', n) && (o = n.call(this, v.strToEl)),
                                            (this.config.templates = (0, v.extend)(i, o));
                                    },
                                },
                                {
                                    key: '_setLoading',
                                ...
                                },
                                {
                                    ...
                                    value: function value() {
                                        ...
                                        (this.containerOuter = i),
                                            (this.containerInner = n),
                                            (this.input = r),
                                            (this.choiceList = o),
                                            (this.itemList = s),
                                            (this.dropdown = a),
                                        ...
                                        if (
                                            (Boolean(c) && this.passedElement.setAttribute('data-choice-orig-style', c),
                                            this.passedElement.setAttribute('style', 'display:none;'),
                                            this.passedElement.setAttribute('aria-hidden', 'true'),
                                            this.passedElement.setAttribute('data-choice', 'active'),
                                            (0, v.wrap)(this.passedElement, n),
                                            (0, v.wrap)(n, i),
                                            this.isSelectOneElement
                                                ? (r.placeholder = this.config.searchPlaceholderValue || '')
                                                : this.placeholder &&
                                                  ((r.placeholder = this.placeholder),
                                                  (r.style.width = (0, v.getWidthOfInput)(r))),
                                            this.config.addItems || this.disable(),
                                            i.appendChild(n),
                                            i.appendChild(a),
                                            n.appendChild(s),
                                            this.isTextElement || a.appendChild(o),
                                            this.isSelectMultipleElement || this.isTextElement
                                                ? n.appendChild(r)
                                                : this.canSearch && a.insertBefore(r, a.firstChild),
                                            this.isSelectElement)
                                        ) {
                    ...
                    !(function (t) {
                        ...
                        function n(e, t) {
                            ...
                            for (i in a) {
                                a.hasOwnProperty(i) &&
                                    ('boolean' == typeof a[i]
                                        ? (this.options[i] = i in t ? t[i] : a[i])
                                        : (this.options[i] = t[i] || a[i]));
                            }
                        }
                        ...
                        function r(e, t) {
                            (t = t || {}),
                                ...
                                (this.options.distance = 'distance' in t ? t.distance : r.defaultOptions.distance),
                                (this.options.threshold = 'threshold' in t ? t.threshold : r.defaultOptions.threshold),
                        ...
                        (n.VERSION = '2.7.3'),
                            ...
                            (n.prototype._analyze = function (e, t, n, s) {
                                ...
                                if (void 0 !== t && null !== t) {
                                    ...
                                    if ('string' == typeof t) {
                                        if (
                                            ((r = t.split(_.tokenSeparator)),
                                            _.verbose && i('---------\nKey:', e),
                                            this.options.tokenize)
                                        ) {
                                            for (b = 0; b < this.tokenSearchers.length; b++) {
                                                for (
                                                    f = this.tokenSearchers[b],
                                                        _.verbose && i('Pattern:', f.pattern),
                                                        p = [],
                                                        g = !1,
                                                        E = 0;
                                                    E < r.length;
                                                    ...
                                                    var w = {};
                                                    m.isMatch
                                                        ? ((w[v] = m.score), (S = !0), (g = !0), a.push(m.score))
                                                        : ((w[v] = 1), this.options.matchAllTokens || a.push(1)),
                                                        p.push(w);
                                                }
                                        ...
                                        (d = this.fullSeacher.search(t)),
                                            _.verbose && i('Full text score:', d.score),
                                            (h = d.score),
                                            void 0 !== l && (h = (h + l) / 2),
                                            _.verbose && i('Score average:', h),
                                            (y =
                                                !this.options.tokenize ||
                                                !this.options.matchAllTokens ||
                                                I >= this.tokenSearchers.length),
                                            _.verbose && i('Check Matches', y),
                                            (S || d.isMatch) &&
                                                y &&
                                                ((c = this.resultMap[s]),
                                                c
                            ...
                            (r.prototype.search = function (e) {
                                ...
                                if (this.patternLen > w.maxPatternLength) {
                                    if (
                                        ((y = e.match(new RegExp(this.pattern.replace(w.tokenSeparator, '|')))),
                                        (b = !!y))
                                    )
                                ...
                                for (
                                    a != -1 &&
                                        ((r = Math.min(this._bitapScore(0, a), r)),
                                        (a = e.lastIndexOf(this.pattern, o + this.patternLen)),
                                        a != -1 && (r = Math.min(this._bitapScore(0, a), r))),
                                        a = -1,
                                        m = 1,
                                        g = [],
                                        h = this.patternLen + n,
                                    ...
                                    for (c = 0, l = h; c < l; ) {
                                        this._bitapScore(t, o + l) <= r ? (c = l) : (h = l),
                                            (l = Math.floor((h - c) / 2 + c));
                                    }

                                    for (
                                        h = l,
                                            u = Math.max(1, o - l + 1),
                                            d = s ? n : Math.min(o + l, n) + this.patternLen,
                                            f = Array(d + 2),
                                            f[d + 1] = (1 << t) - 1,
                                            i = d;
                                        i >= u;
                                        ...
                                        if (
                                            ((v = this.patternAlphabet[e.charAt(i - 1)]),
                                            v && (E[i - 1] = 1),
                                            (f[i] = ((f[i + 1] << 1) | 1) & v),
                                            0 !== t && (f[i] |= ((p[i + 1] | p[i]) << 1) | 1 | p[i + 1]),
                                            f[i] & this.matchmask && ((m = this._bitapScore(t, i - 1)), m <= r))
                                        ) {
                                    ...
                                    (t = e[o]),
                                        t && n === -1
                                            ...
                                            : t ||
                                              n === -1 ||
                                              ((s = o - 1),
                                              s - n + 1 >= this.options.minMatchCharLength && i.push([n, s]),
                                              (n = -1));
                                }

                                return (
                                    e[o - 1] && o - 1 - n + 1 >= this.options.minMatchCharLength && i.push([n, o - 1]),
                                    i
                                );
                            }),
                            (e.exports = n);
                ...
                function (e, t, i) {
                    ...
                    function s(e, t, i) {
                        ...
                        if (
                            ('function' == typeof t && 'undefined' == typeof i && ((i = t), (t = void 0)),
                            'undefined' != typeof i)
                        ) {
                ...
                function (e, t) {
                    ...
                    var i =
                        ...
                        r =
                            ((t.isNode = function (e) {
                                return 'object' === ('undefined' == typeof Node ? 'undefined' : i(Node))
                                    ? e instanceof Node
                                    : e &&
                                        ...
                                        n = function n(i) {
                                            for (var n in i) {
                                                Object.prototype.hasOwnProperty.call(i, n) &&
                                                    (o('Object', i[n]) ? (t[n] = e(!0, t[n], i[n])) : (t[n] = i[n]));
                                            }
                                        },
                                        s = 0;
                                    s < i;
                        ...
                        a =
                                ...
                                for (var n = []; e && e !== document; e = e.parentNode) {
                                    ...
                                    if (i) {
                                        ...
                                        '.' === o && e.classList.contains(i.substr(1)) && n.push(e),
                                            ...
                                            '[' === o && e.hasAttribute(i.substr(1, i.length - 1)) && n.push(e),
                            ...
                            (t.isInView = function (e, t, i) {
                                return (
                                    this.getScrollPosition(t) > this.getElemDistance(e) + this.getElementOffset(e, i)
                                );
                            }),
                    ...
                    (t.getWidthOfInput = function (e) {
                        ...
                        if (t) {
                            ...
                            if (
                                ...
                                s &&
                                    ((n.style.fontSize = s.fontSize),
                                    (n.style.fontFamily = s.fontFamily),
                                    (n.style.fontWeight = s.fontWeight),
                                    (n.style.fontStyle = s.fontStyle),
                        ...
                        Array.from ||
                            (Array.from = (function () {
                                ...
                                return function (e) {
                                    ...
                                    for (
                                        var a, c = s(n.length), l = t(i) ? Object(new i(c)) : new Array(c), h = 0;
                                        h < c;
                            ...
                            Array.prototype.find ||
                                (Array.prototype.find = function (e) {
                                    ...
                                    for (
                                        var t, i = Object(this), n = i.length >>> 0, s = arguments[1], o = 0;
                                        o < n;
                                        o++
                                    ) {
                    ...
                    value: function _createTemplates(template) {
                        ...
                        return {
                            itemList: function itemList() {
                                ...
                                return template(
                                    '\n          <div class="'
                                        .concat(classNames.input, ' ')
                                        .concat(classNames.listItems, '"></div>')
                                );
                            },
                                ...
                                if (_this.config.removeItemButton) {
                                    return template(
                                        '\n              <div class="'
                                            ...
                                            .concat(
                                                _this.passedElement.type === 'select-one' ? '' : pillClass,
                                                '\n                '
                                            )
                                            .concat(
                        ...
                        vl.util.each(this.selectInstances, function (instance) {
                            if (instance.element === select) {
                                ...
                                var closeButton =
                                    ...
                                    instance.containerOuter.querySelector('.'.concat(pillCloseClass));
                ...
                },
                {
                    ...
                    value: function dressAll() {
                        ...
                        var selectFields = document.querySelectorAll(
                                '['
                                    .concat(sSelectorAtt, ']:not([')
                                    .concat(sDressedAtt, ']):not([data-')
                                    .concat(vl.ns, 'js-dress="false"])')
                            ),
                            multiSelectFields = document.querySelectorAll(
                                '['
                                    .concat(sMultiSelectorAtt, ']:not([')
                                    .concat(sMultiDressedAtt, ']):not([data-')
                                    .concat(vl.ns, 'js-dress="false"])')
                            );
