...
if [ $? -eq 0 ]
  then
    ...
    echo "build playground-legacy - error" >&2
fi
...
if [ $? -eq 0 ]
  then
    ...
    echo "build playground-lit - error" >&2
fi
...
if [ $? -eq 0 ]
  then
    ...
    echo "build playground-native - error" >&2
fi
...
if [ $? -eq 0 ]
  then
    ...
    echo "build playground-react - error" >&2
fi
