 ...
 * @deprecated
 */
@webComponent('vl-http-412-message')
export class VlHttp412Message extends BaseLitElement {
    static {
    ...
    render() {
        return html`<vl-http-error-message data-vl-error-code="412"> </vl-http-error-message> `;
    }
}
