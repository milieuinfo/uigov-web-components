 ...
 * @deprecated
 */
@webComponent('vl-http-505-message')
export class VlHttp505Message extends BaseLitElement {
    static {
    ...
    render() {
        return html`<vl-http-error-message data-vl-error-code="505"> </vl-http-error-message> `;
    }
}
