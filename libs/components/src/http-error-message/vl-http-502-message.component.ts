 ...
 * @deprecated
 */
@webComponent('vl-http-502-message')
export class VlHttp502Message extends BaseLitElement {
    static {
    ...
    render() {
        return html`<vl-http-error-message data-vl-error-code="502"> </vl-http-error-message> `;
    }
}
