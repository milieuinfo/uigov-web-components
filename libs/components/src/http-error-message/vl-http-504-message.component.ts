 ...
 * @deprecated
 */
@webComponent('vl-http-504-message')
export class VlHttp504Message extends BaseLitElement {
    static {
    ...
    render() {
        return html`<vl-http-error-message data-vl-error-code="504"> </vl-http-error-message> `;
    }
}

declare global {
    interface HTMLElementTagNameMap {
        'vl-http-504-message': VlHttp504Message;
    }
}
