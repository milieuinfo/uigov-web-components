 ...
 * @deprecated
 */
@webComponent('vl-http-413-message')
export class VlHttp413Message extends BaseLitElement {
    static {
    ...
    render() {
        return html`<vl-http-error-message data-vl-error-code="413"> </vl-http-error-message> `;
    }
}

declare global {
    interface HTMLElementTagNameMap {
        'vl-http-413-message': VlHttp413Message;
    }
}
