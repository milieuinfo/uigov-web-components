...
<CustomDocMetaData id="components-next-properties" />
...
Deze component is de nieuwste variant die de (nog als element geschreven)
[vl-properties](/docs/elements-properties--documentatie) vervangt.
