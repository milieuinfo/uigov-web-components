...
import * as VlDataTableStories from './vl-data-table.stories';

# Data Table

<CustomDocMetaData id="elements-data-table" />
...
<Canvas of={VlDataTableStories.DataTableDefault} layout="padded" />


## Functionaliteit

Standaard is er geen sorteer, filtering of paginatie functionaliteit beschikbaar voor de `data-table`. Hiervoor is de
[rich-data-table](?path=/docs/components-rich-data-table--rich-data-table-default) beschikbaar.<br/>
...
<Canvas of={VlDataTableStories.DataTableJoinedRowTitles} layout="padded" />
...
<Canvas of={VlDataTableStories.DataTableExpandableCustomToggleDetailsColumn} layout="padded" />


## Configuratie

<ArgTypes of={VlDataTableStories.DataTableDefault} />
...
[Legacy Storybook - Data Table](https://webcomponenten.omgeving.vlaanderen.be/storybook/?path=/docs/native-elements-vl-data-table--default)

[Legacy Documentatie - Data Table](https://webcomponenten.omgeving.vlaanderen.be/doc/VlDataTable.html)

[Legacy Demo - Data Table](https://webcomponenten.omgeving.vlaanderen.be/demo/vl-data-table.html)
