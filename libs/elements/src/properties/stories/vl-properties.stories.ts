...
export default {
    ...
    title: 'Elements/properties [deprecated]',
    tags: ['autodocs'],
...
export const PropertiesDefault = story(
    propertiesArgs,
    ({ collapsed, fullWidth }) => html`
...
PropertiesDefault.args = {
    collapsed: propertiesArgs.collapsed,
    fullWidth: propertiesArgs.fullWidth,
};

export const PropertiesColumn = story(
    propertiesArgs,
    ({ collapsed, full, fullWidth }) => html`
        <vl-properties ?data-vl-full-width=${fullWidth} ?data-vl-collapsed=${collapsed}>
            <h4 is="vl-h4">Gegevens</h4>
