...
<Alert title="Deprecated">
    {`In v2.0.0 verdwijnt deze component.<br> Meer info over validatie binnen onze form componenten vind je hier: [Form - Validatie](/docs/ontwerp-form-validation--documentatie)`}
</Alert>
