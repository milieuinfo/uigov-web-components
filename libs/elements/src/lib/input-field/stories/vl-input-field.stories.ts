...
const InputFieldFormWithValidationTemplate: StoryFn<typeof inputFieldArgs> = ({
    validationType,
    required,
    errorMessage,
    errorPlaceholder,
...
`;
export const InputFieldFormWithValidation = InputFieldFormWithValidationTemplate.bind({});
...
export const inputFieldFormWithNumericalValidation = InputFieldFormWithValidationTemplate.bind({}) as any;
