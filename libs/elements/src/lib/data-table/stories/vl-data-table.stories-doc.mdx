...
Standaard is er geen sorteer, filtering of paginatie functionaliteit beschikbaar voor de `data-table`. Hiervoor is de [rich-data-table](?path=/docs/components-rich-data-table--rich-data-table-default) beschikbaar.
...
Gebruik de matrixvariant om gegevens met 2 dimensies weer te geven. Zowel de rijen als de kolommen krijgen een titel. De titels zijn gescheiden van de inhoud met een vetgedrukte lijn.
...
Om een rijen te laten uitklappen ("expanden") moet je het volgende doen:
