...
// Flanders font
export const fontFamily = 'FlandersArtSans'; // basis font
export const serifFontFamily = 'FlandersArtSerif'; // accent font

// Icon font
export const iconFontFamily = 'vlaanderen-icon-classic';
export const iconFontLocation = `${baseFontLocation}/iconfont/${iconFontFamily}`;
