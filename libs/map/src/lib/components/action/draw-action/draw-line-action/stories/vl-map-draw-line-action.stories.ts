...
export const MapDrawLineActionDefault: StoryFn<typeof mapDrawActionArgs> = ({ active, defaultActive }) => html`
    <vl-map>
...
export const MapDrawLineActionSnapping: StoryFn<typeof mapDrawActionArgs> = ({
    active,
    defaultActive,
    snapping,
