...
Gebruik de `checkbox-next` component om de gebruiker de mogelijkheid te geven om 1 of meerdere dingen te selecteren in
een lijst.<br/>
Deze component is de opvolger van de [vl-checkbox](/docs/components-checkbox--documentatie) component, we raden
aan deze nieuwe versie te gebruiken.
