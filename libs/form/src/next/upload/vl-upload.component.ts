...
export class VlUploadComponent extends FormControl {
    ...
    // Variables
    private dropzoneInstance: any | undefined | null;
    ...
    updated(changedProperties: Map<string, unknown>) {
        ...
        if (changedProperties.has('readonly')) {
            ...
            if (this.dropzoneInstance) {
                const dropzoneInstance = this.dropzoneInstance as {
    ...
    addFile(file: File) {
        if (this.dropzoneInstance) {
            ...
            this.dropzoneInstance.addFile(<any>file);
    ...
    private async updateFileList(dropzone: any, file?: any) {
