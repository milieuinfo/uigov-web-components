...
Deze component is de opvolger van de [vl-select](?path=/docs/elements-select--select-default) component en de
[vl-multiselect](?path=/docs/elements-multiselect--multiselect-default) component, we raden aan deze nieuwe versie te
gebruiken.
