...
Als de gebruiker een optie selecteert of verwijdert, wordt het `vl-select` event afgevuurd. Het detail object van dit event bevat de value van de geselecteerde opties.<br/>
