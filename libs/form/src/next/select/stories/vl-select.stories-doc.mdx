...
Bij het selecteren of verwijderen van een optie wordt het `vl-select` event afgevuurd, het detail object van dit event bevat de value van de geselecteerde optie als string.
Bij het gebruik van de multiselect worden meerdere values gescheiden door een `;`.
