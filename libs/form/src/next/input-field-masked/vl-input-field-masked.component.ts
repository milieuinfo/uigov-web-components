...
export class VlInputFieldMaskedComponent extends VlInputFieldComponent {
    ...
    protected onInput() {
        // ipv op native input event te luisteren, maken we gebruik van onValueChanged-callback van cleave.js
        // zodat we meteen de getransformeerde waarde verkrijgen
    }
    ...
    // wordt gebruikt voor onValueChanged callback van cleave.js
