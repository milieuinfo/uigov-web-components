...
registerWebComponents([VlRegionElement, VlLayoutElement, VlQlikInfoblockComponent]);
...
describe('qlik infoblock', () => {
    ...
    it('child components rendered', () => {
        // info block content
        cy.get('vl-qlik-infoblock').shadow().find('vl-infoblock').should('exist');
        ...
        cy.get('vl-qlik-infoblock').shadow().find('vl-infoblock').find('vl-info-tile').should('exist');
