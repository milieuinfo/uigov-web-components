...
export const qlikVisualArgTypes: ArgTypes<typeof qlikVisualArgs> = {
    ...
    qlikId: {
        name: 'qlik-id',
        description: 'Het object id van de visualisatie in Qlik.',
        table: {
            type: { summary: TYPES.STRING },
            category: CATEGORIES.ATTRIBUTES,
    ...
    height: {
        name: 'height',
        description: 'De hoogte van de visualisatie.',
        table: {
            type: { summary: TYPES.STRING },
            category: CATEGORIES.ATTRIBUTES,
    ...
    width: {
        name: 'width',
        description: 'De breedte van de visualisatie.',
        table: {
            type: { summary: TYPES.STRING },
            category: CATEGORIES.ATTRIBUTES,
    ...
    additionalStyle: {
        ...
        description:
            'Styling die meegegeven kan worden om op de div te zetten in de shadowroot waarin de visualisatie gerendered wordt.',
        table: {
            type: { summary: TYPES.STRING },
            category: CATEGORIES.ATTRIBUTES,
    ...
    properties: {
        name: 'properties',
        description:
            'Properties die aan een visualisatie kunnen meegegeven worden. Zoals <code>{"dataPoint": {"bubbleScales": 50}}</code> voor distributionplot.',
        table: {
