...
import {Qlik, STARDUST} from "@domg/qlik-lib/build/release/index.js";
import {until} from 'lit/directives/until.js';

export default {
    title: 'qlik/qlik-visual',
    args: storyArgs(qlikVisualArgs),
    argTypes: storyArgTypes(qlikVisualArgTypes),
    parameters: {
        docs: {
            page: qlikVisualDoc,
        },
...
const Template = (withoutInteraction = false) => story(
    qlikVisualArgs,
    (args) => html`${
        until(
...
const QlikVisualDefault = Template().bind({});
...
const QlikVisualWithInteraction = Template().bind({});
...
const QlikVisualWithoutInteraction = Template(true).bind({});
...
export {QlikVisualDefault, QlikVisualWithInteraction, QlikVisualWithoutInteraction};
