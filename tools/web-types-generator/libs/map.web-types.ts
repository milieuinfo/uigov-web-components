...
export const mapWebTypes: WTComponentList = [
    addWebTypes(
        'vl-map-click-action',
    ...
    addWebTypes('vl-map-click-action-pindrop', null, null, null),
    addWebTypes(
    ...
    addWebTypes('vl-map-layer-action', null, null, null),
    addWebTypes(
    ...
    addWebTypes('vl-map-side-sheet-menu', null, null, '/docs/map-side-sheet-side-sheet-menu-item--documentatie'),
    addWebTypes(
