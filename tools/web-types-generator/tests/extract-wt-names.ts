...
// console.log('ComponentWTNames', extractComponentWTNames());
// console.log('ElementsWTNames', extractElementsWTNames());
// console.log('FormWTNames', extractFormWTNames());
// console.log('MapWTNames', extractMapWTNames());
// console.log('QlikWTNames', extractQlikWTNames());
// console.log('SectionsWTNames', extractSectionsWTNames());
