...
console.log('elements - aantal web-components:', elementWCNames.length);

console.log('elements - aantal web-types:', elementWTNames.length);

console.log(
    'elements - web-components waar er geen web-type voor gespecifieerd is',
    elementWCNames.filter((name) => !elementWCIgnore.includes(name) && !elementWTNames.includes(name))
);

console.log(
    'components - web-types waar er geen web-component voor bestaat',
    elementWTNames.filter((name) => !elementWTMismatch.includes(name) && !elementWCNames.includes(name))
);
