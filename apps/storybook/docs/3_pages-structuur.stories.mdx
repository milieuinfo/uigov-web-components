...
<Meta title="Ontwikkeling/Pages Structuur" />

# Pages Structuur

## Beschrijving

Documentatie wordt gepubliceerd op de documentatie website (https://milieuinfo.github.io/uigov-pages), de structuur van
die repo staat hier beschreven.
...
│  ├─ _site/
│  │  -> de gegenereerde website die gepublieerd wordt onder https://milieuinfo.github.io/uigov-pages/
```
