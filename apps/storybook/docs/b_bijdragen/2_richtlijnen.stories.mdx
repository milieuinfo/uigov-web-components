...
1. kijk onder [Afnemen/Artifacts](/story/afnemen-artifacts--page) naar de verschillen tussen elementen en componenten
...
website vind je het overzicht van alle
[beschikbare iconen](https://overheid.vlaanderen.be/webuniversum/v3/documentation/atoms/vl-ui-icon/).

### Storybook

Richtlijnen m.b.t. Storybook vind je terug op de [Bijdragen/Storybook](/story/bijdragen-storybook--page) pagina.

### Cypress

TODO - Kris S. - waar gaan we dit documenteren ?
