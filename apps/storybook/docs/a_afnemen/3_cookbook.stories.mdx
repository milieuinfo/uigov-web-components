...
De `fat-js` bestanden zijn beschikbaar onder `https://cdn.omgeving.vlaanderen.be/domg/wc`, daar staan per versie 3
bestanden:

- **domg-wc-1.18.0.js** - de leesbare variant [7,3 MB]
- **domg-wc-1.18.0.js.map** - de map file om de leesbare variant te debuggen [11,3 MB]
- **domg-wc-1.18.0.min.js** - de productie versie [3,4 MB]
