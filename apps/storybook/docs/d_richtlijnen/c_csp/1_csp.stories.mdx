...
Zie ook de [Confluence pagina](https://www.milieuinfo.be/confluence/display/FEO/CSP+compliance) over dit onderwerp<br/>
&nbsp;&nbsp;-> op te nemen op of naast deze pagina en te verwijderen uit confluence

## Inleiding

Volgende zaken zijn er al gedaan m.b.t. CSP:
...
In de 2e helft van 2024 worden alle elementen omgezet naar volwaardige componenten. Ook deze nieuw code wordt ineens
