...
import { customElement } from 'lit/decorators.js';
import { vlElementsStyle, VlIconElement, VlIconWrapperElement } from '@domg-wc/elements';
import {
    ...
    render(): TemplateResult {
        return html`
            <main>
                ...
                align-items: center;"
                >
                    <h4 is="vl-h4" class="vl-title--has-border">
                        Kies uit kantoren - Toolttip left
                        <vl-tooltip data-vl-placement="left"
                            >Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                            <a href="#">tempor incididunt</a> ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                            quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
                            irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
                            Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit
                            anim id est laborum.</vl-tooltip
                        >
                    </h4>
                    <h4 is="vl-h4" class="vl-title--has-border">
                        Kies uit kantoren - Toolttip down
                        <vl-tooltip data-vl-placement="top"
                            >Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                            <a href="#">tempor incididunt</a> ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                            quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
                            irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
                    ...
                    <vl-radio-group id="radio-group-2">
                        <p is="vl-icon-wrapper">
                            <vl-radio id="radio-group-2-radio-1" data-vl-label="Ja Met tooltip" data-vl-value="yes">
                            </vl-radio>
                            <span is="vl-icon" data-cy="icon-after-element" data-vl-icon="info-filled" data-vl-after="">
                                <vl-tooltip data-vl-placement="bottom"
                                    >Kies Ja of Nee quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
                        ...
                        <div>
                            <vl-radio id="radio-group-2-radio-2" data-vl-label="Nee Met tooltip" data-vl-value="yes">
                            </vl-radio>
                            <span
                                is="vl-icon"
                                data-cy="icon-after-element"
                                data-vl-icon="info-filled"
                                data-vl-after="true"
                            >
                                <vl-tooltip data-vl-placement="bottom"
                                    >Kies Ja of Nee quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
                        ...
                        <vl-radio id="radio-group-2-radio-2" data-vl-value="yes" style="">
                            Misschien zonder data-vl-label met tooltip
                            <span
                                is="vl-icon"
                                data-cy="icon-after-element"
                                data-vl-icon="info-filled"
                    ...
                    <h4 is="vl-h4" class="vl-title--has-border">Anedere Titel section voor Radio Btns</h4>

                    <vl-radio-group id="radio-group-2">
                        <vl-radio id="radio-group-2-radio-1" data-vl-label="Ja" data-vl-value="yes"> </vl-radio>
                        <vl-radio id="radio-group-2-radio-1" data-vl-label="Ja" data-vl-value="Nee"> </vl-radio>
                    </vl-radio-group>
                </div>
            </main>
        `;
