...
export class AppElement extends LitElement {
    ...
    static {
        registerWebComponents([VlInputFieldComponent, VlErrorMessageComponent, VlCheckboxComponent]);
    }
                    ...
                    <div class="vl-form-grid vl-form-grid--is-stacked">
                        ...
                        <div class="vl-col--9-12">
                            <vl-input-field-next
                                ...
                                @input=${(event: Event) => (this.firstName = (event.target as HTMLInputElement).value)}
                            ></vl-input-field-next>
                            <vl-error-message-next input-id="voornaam" state="valueMissing"
                                >Gelieve een voornaam in te vullen.</vl-error-message-next
                            >
                            <vl-error-message-next input-id="voornaam" state="tooShort"
                                >Gelieve minimum 5 karakters te gebruiken.</vl-error-message-next
                            >
                            <vl-error-message-next input-id="voornaam" state="tooLong"
                        ...
                        <div class="vl-col--9-12">
                            <vl-input-field-next
                                ...
                                pattern="Van(.*)"
                            ></vl-input-field-next>
                            <vl-error-message-next input-id="achternaam" state="valueMissing"
                                >Gelieve een achternaam in te vullen.</vl-error-message-next
                            >
                            <vl-error-message-next input-id="achternaam" state="patternMismatch"
                        ...
                        <div class="vl-col--9-12">
                            ...
                            ></vl-input-field-next>
                            <vl-error-message-next input-id="leeftijd" state="valueMissing"
                                >Gelieve een leeftijd in te vullen.</vl-error-message-next
                            >
                            <vl-error-message-next input-id="leeftijd" state="rangeUnderflow"
                                >De minimum leeftijd is 1 jaar.</vl-error-message-next
                            >
                            <vl-error-message-next input-id="leeftijd" state="rangeOverflow"
                        ...
                        <div class="vl-col--9-12">
                            ...
                            ></vl-input-field-next>
                            <vl-error-message-next input-id="kinderen" state="valueMissing"
                                >Gelieve een aantal kinderen in te vullen.</vl-error-message-next
                            >
                            <vl-error-message-next input-id="kinderen" state="rangeUnderflow"
                        ...
                        ${this.showAddressField
                            ? html`
                                  ...
                                  <div class="vl-col--9-12">
                                      ...
                                      ></vl-input-field-next>
                                      <vl-error-message-next input-id="adres" state="valueMissing"
                        ...
                        <div class="vl-col--9-12">
                            <vl-checkbox-next id="confirmation" name="confirmation" block required></vl-checkbox-next>
                            <vl-error-message-next input-id="confirmation" state="valueMissing"
