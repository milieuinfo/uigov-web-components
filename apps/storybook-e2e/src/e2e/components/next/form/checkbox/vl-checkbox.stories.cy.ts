const checkboxNextUrl =
    'http://localhost:8080/iframe.html?id=components-next-form-checkbox--checkbox-default&viewMode=story&args=';
const checkboxNextSwitchUrl =
    'http://localhost:8080/iframe.html?id=components-next-form-checkbox--checkbox-switch&viewMode=story&args=';
