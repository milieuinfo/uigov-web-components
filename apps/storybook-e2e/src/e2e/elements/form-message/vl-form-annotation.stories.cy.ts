const formAnnotationDefaultUrl =
    'http://localhost:8080/iframe.html?id=elements-form-message-form-annotation--form-annotation-default&viewMode=story';
const formAnnotationSpanUrl =
    'http://localhost:8080/iframe.html?id=elements-form-message-form-annotation--form-annotation-span&viewMode=story';
