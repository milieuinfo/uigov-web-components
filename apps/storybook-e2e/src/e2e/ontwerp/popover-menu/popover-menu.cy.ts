const PopoverMenuHamburgerUrl =
    'http://localhost:8080/iframe.html?args=&id=ontwerp-popover-menu--hamburger-menu&viewMode=story';
const PopoverMenuKebabrUrl =
    'http://localhost:8080/iframe.html?args=&id=ontwerp-popover-menu--kebab-menu&viewMode=story';
const PopoverMenuMeatballUrl =
    'http://localhost:8080/iframe.html?args=&id=ontwerp-popover-menu--meatball-menu&viewMode=story';
